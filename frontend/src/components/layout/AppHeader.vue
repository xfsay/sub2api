    ...
    <div class="contents">
      ...
      <div class="flex min-w-0 items-center gap-3">
        ...
        <div class="hidden min-w-0 lg:block">
          <h1 class="app-header-title truncate font-semibold">
            {{ pageTitle }}
          </h1>
          <p v-if="pageDescription" class="sr-only">
            {{ pageDescription }}
          </p>
        </div>
      </div>
      ...
      <div class="app-header-actions">
        ...
        <a
          ...
          class="app-icon-button hidden sm:inline-grid"
        ...
        >
          ...
          <span class="sr-only">{{ t('nav.modelPlaza') }}</span>
        </router-link>
        ...
        <div
          v-if="user"
          class="app-header-balance group relative hidden items-center sm:flex"
        >
          <svg
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          ...
          >
            ...
            <Icon name="chevronDown" size="sm" class="hidden" />
          </button>
